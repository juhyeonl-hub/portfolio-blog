---
title: "AI-first 개발 워크플로를 처음부터 설계하기"
excerpt: "코드를 쓰는 일에서 — 지시하고, 판단하고, 검증하는 일로."
tags: [Dev, AI]
---
...
AI-first 개발은 개발자에게 덜이 아니라 더 많은 것을 요구한다. 전체 설계를 머릿속에 들고 있어야 하고, 결과물의 품질을 판단해야 하고, 무엇이 정확히 잘못됐는지 짚어낼 수 있어야 한다. AI 시대 개발자의 가치는 좋은 코드와 나쁜 코드를 구분하는 능력 — 그리고 그 능력은 기초에서 나온다.
